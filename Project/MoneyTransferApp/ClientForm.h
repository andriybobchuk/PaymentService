...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Size = System::Drawing::Size(268, 552);
			...
			this->label2->Size = System::Drawing::Size(218, 23);
			this->label2->TabIndex = 1;
			this->label2->Text = L"andriybobchuk@gmail.com";
			...
			this->label1->Size = System::Drawing::Size(181, 46);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Ins\'n\'Outs";
			...
			this->ClientSize = System::Drawing::Size(1042, 541);
